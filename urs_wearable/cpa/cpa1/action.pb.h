...
// required int32 wp_id = 2;
inline bool Goto::has_wp_id() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Goto::set_has_wp_id() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Goto::clear_has_wp_id() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void Goto::clear_wp_id() {
  wp_id_ = 0;
  clear_has_wp_id();
}
inline ::google::protobuf::int32 Goto::wp_id() const {
  // @@protoc_insertion_point(field_get:pb_urs.Goto.wp_id)
  return wp_id_;
}
inline void Goto::set_wp_id(::google::protobuf::int32 value) {
  set_has_wp_id();
  wp_id_ = value;
  // @@protoc_insertion_point(field_set:pb_urs.Goto.wp_id)
}
