...
bool readDelimitedFrom(google::protobuf::io::ZeroCopyInputStream* rawInput, google::protobuf::MessageLite* message)
{
  ...
  // than on the whole stream. (See the CodedInputStream interface for more info on this limit.)
...
bool writeDelimitedTo(google::protobuf::io::ZeroCopyOutputStream* rawOutput,
